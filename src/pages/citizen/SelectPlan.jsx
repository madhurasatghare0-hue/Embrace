...
import { Check } from 'lucide-react'
import { getSession } from '../../data/db'
import { getCitizenById, setCitizenPlan, assignCaretakerToCitizen } from '../../data/citizens'
...
function CitizenSelectPlan() {
  ...
  navigate('/citizen/payment', { state: { plan: planData } })
  return
}
    ...
    if (caretaker) {
      assignCaretakerToCitizen(citizen.id, caretaker.id)
    }
          ...
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-2xl font-bold text-[#3D2A6D] mb-6">
