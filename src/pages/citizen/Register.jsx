...
// import { useLocation, useNavigate } from 'react-router-dom'
// import {
//   Check, Heart, ShieldCheck, Clock3, UsersRound, ArrowRight, LockKeyhole,
// } from 'lucide-react'
...
// import RegistrationSuccessModal from '../../components/citizen/RegistrationSuccessModal'
// import SelectPlanModal from '../../components/citizen/SelectPlanModal'
...
// const [stepIndex, setStepIndex] = useState(0)
// const [stage, setStage] = useState(null) // null | 'success' | 'plan' | 'payment'
// const [citizen, setCitizen] = useState(null)
// const [formData, setFormData] = useState({})
...
//   const currentSection = registrationSections[stepIndex]
//   const isLastStep = stepIndex === registrationSections.length - 1
...
//     id: plan.id, name: plan.name, maxHouses: plan.maxHouses, price: plan.price,
//   })
//   const caretaker = findAvailableCaretaker(plan.maxHouses)
//   if (caretaker) assignCaretakerToCitizen(citizen.id, caretaker.id)
...
//     {stage === 'plan' && (
//       <SelectPlanModal onSelect={handleSelectPlan} selectingId={selectingId} />
//     )}

//     {stage === 'payment' && selectedPremiumPlan && (
//       <PaymentModal plan={selectedPremiumPlan} onPay={handlePaymentComplete} />
//     )}

    
//     <div className="min-h-screen bg-[#fffafc] relative">
//       <div className="absolute top-20 left-[5%] w-4 h-4 bg-[#ff8b55] rounded-full opacity-80 pointer-events-none" />
     

//       <div className="relative max-w-[1320px] mx-auto px-5 sm:px-7 lg:px-8 pt-12 pb-7 lg:pt-14 lg:pb-7">
//         <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-8 items-start">
...
//             <div className="max-w-[570px] mx-auto lg:mx-0">
//               <div className="relative flex justify-center mb-8">
//                 <div className="absolute top-5 left-1/2 -translate-x-1/2 w-[82%] aspect-square rounded-full border-[5px] border-white pointer-events-none" />
//                 <div className="absolute top-10 right-[8%] w-10 h-10 rounded-full bg-[#eadcf8]" />

//                 <div
//                   className="relative z-10 w-[82%] aspect-square overflow-hidden shadow-[0_18px_45px_rgba(74,48,113,0.14)]"
//                   style={{ borderRadius: '48% 52% 50% 50% / 45% 44% 56% 55%' }}
//                 >
//                   <img src={aboutImage} alt="ElderCare family" className="w-full h-full object-cover" />
//                   <div className="absolute inset-0 bg-gradient-to-t from-[#3d276d]/10 to-transparent pointer-events-none" />
//                 </div>
//               </div>

//               <div className="text-center lg:text-left px-4 lg:px-6">
//                 <h1 className="font-serif text-3xl md:text-4xl xl:text-[44px] font-bold text-[#30235c] leading-tight">
//                   Let's Get to Know <span className="text-[#ef6730]">You</span>
//                 </h1>
//                 <p className="mt-4 text-gray-500 text-sm md:text-base leading-7 max-w-[480px] mx-auto lg:mx-0">
//                   Just a few details help us match you with the right caretaker and care plan for
//                   your needs.
//                 </p>
//               </div>
...
//   <div className="relative w-full max-w-[700px] bg-white rounded-[28px] shadow-[0_15px_45px_rgba(61,42,109,0.10)] h-[calc(100vh-100px)] max-h-[850px] flex flex-col overflow-hidden">

//      {/* FIXED TOP SECTION */}
//     <div className="shrink-0 px-2 sm:px-8 pt-5 sm:pt-6 bg-white z-20">

//       <div className="mb-5 w-full">
//   <div className="flex items-start w-full">
//     {registrationSections.map((section, index) => {
//       const isActive = index === stepIndex
//       const isComplete = index < stepIndex
//       const isLast = index === registrationSections.length - 1
...
//             <span
//               title={section.title}
//               className={`mt-1.5 w-full px-1 text-[2px] sm:text-[10px] font-medium text-center whitespace-nowrap overflow-hidden text-ellipsis ${
//                 isActive
//                   ? 'text-[#7138c5]'
//                   : isComplete
//                   ? 'text-[#3D2A6D]'
...
//           {!isLast && (
//             <div className="w-4 sm:w-6 lg:w-8 shrink-0 mt-5 border-t-2 border-dashed border-gray-200" />
//           )}
//         </div>
//       )
//     })}
...
//         <h2 className="font-serif text-2xl md:text-2xl font-bold text-[#30235c]">
//           {currentSection.title}
//         </h2>
...
//         <div className="mt-3 w-10 h-1 rounded-full bg-gradient-to-r from-[#8B4FC7] to-[#F0854D] hover:opacity-90 transition-opacity" />
//       </div>
//     </div>
...
//     <div className="shrink-0 bg-white border-t border-gray-100 px-6 sm:px-8 py-5 z-20">
...
//             type="button"
//             onClick={handleBack}
//             className="px-6 py-3.5 rounded-full font-semibold text-[#6736b9] border-2 border-[#6736b9]/20 bg-white hover:bg-[#f8f3ff] transition-all"
//           >
//             Back
//           </button>
//         )}
...
//         <button
//           type="submit"
//           form="citizen-registration-form"
...
import aboutImage from '../../assets/images/about.png'
import elderlyGroupImage from '../../assets/images/elderly-group.jpg'
import { createCitizen } from '../../data/citizens'
import { setSession } from '../../data/db'
import { registrationSections } from '../../data/registrationConfig'
import FieldRenderer from '../../components/forms/FieldRenderer'
...
const [selectedPremiumPlan, setSelectedPremiumPlan] = useState(null)
  ...
  const showPostRegistrationBackground = stage !== null
...
const handlePaymentComplete = () => {
  ...
  <>
    ...
    <div
      className={`min-h-screen relative transition-[background] duration-500 ${
        showPostRegistrationBackground ? '' : 'bg-[#fffafc]'
      }`}
      style={
        showPostRegistrationBackground
          ? {
              backgroundImage: `linear-gradient(180deg, rgba(48,35,92,0.78), rgba(239,103,48,0.55)), url(${elderlyGroupImage})`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-8 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-24 self-start">
            <div className="max-w-[570px] mx-auto lg:mx-0">
              ...
              <div className="text-center lg:text-left px-4 lg:px-6">
                <h1 className="font-serif text-3xl md:text-4xl xl:text-[44px] font-bold leading-tight text-[#30235c]">
                  Let's Get to Know <span className="text-[#ef6730]">You</span>
                </h1>
                <p className="mt-4 text-sm md:text-base leading-7 max-w-[480px] mx-auto lg:mx-0 text-gray-500">
                  Just a few details help us match you with the right caretaker and care plan for
                  your needs.
                </p>
              </div>
